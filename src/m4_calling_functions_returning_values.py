...
def run_test_digits_in_cube():
    ...
    print('-----------------------------------------------------')
    print('expected', 10, 'actual',digits_in_cube(7))
    print('expected' , 8, 'actual', digits_in_cube(5))
...
def run_test_digits_in_power():
    ...
    print('--------------------------------------------------')
    print('expected', 18, 'actual', digits_in_power(12, 3))
    print('expected', 2, 'actual', digits_in_power(2, 1))
    print('expected', 11, 'actual', digits_in_power(10, 3))
...
def run_test_fancy_sums_of_digits():
    ...
    print('--------------------------------------------------')
    print('expected', 1, 'actual', fancy_sums_of_digits(10))
    print('expected', 1, 'actual', fancy_sums_of_digits(100))
    print('expected', 1, 'actual', fancy_sums_of_digits(1))
    # -------------------------------------------------------------------------
