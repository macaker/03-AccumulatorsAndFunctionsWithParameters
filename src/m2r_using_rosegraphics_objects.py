...
#                   rg.Rectangle((4, 4), (8, 8))
#                   rg.Ellipse(( 1, 1), (2 ,2))
#
#          -- Write the names of three METHODs that Circle objects have.
#               fill_color, attach to, outline_color
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                center point, raidus, 'blue'
#
#     f. What does a RoseWindow RENDER method do?
#            displays the coded feature at a certain time
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            keeps window open until user clicks/the user may want to view the window at thier own pace
#
